...
import frpc.fault.retry.RetryStrategyFactory;
import frpc.fault.tolerant.TolerantStrategy;
import frpc.fault.tolerant.TolerantStrategyFactory;
...
//            ServiceMetaInfo selectedService = serviceMetaInfoList.get(0);
        ...
        try {
            ...
            response = retryStrategy.doRetry(()-> VertxTcpClient.doRequest(rpcRequest, selectedService));
        } catch (Exception e) {
